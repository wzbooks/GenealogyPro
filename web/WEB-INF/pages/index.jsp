...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="/BA/css/global.css" media="all">
		<link rel="stylesheet" href="/BA/plugins/font-awesome/css/font-awesome.min.css">
	...
	<body>
		<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
			...
			<script type="text/javascript" src="/BA/plugins/layui/layui.js"></script>
			<script type="text/javascript" src="/BA/datas/nav.js"></script>
			<script src="/BA/js/index.js"></script>
			<script>
				layui.use('layer', function() {
                    ...
                    $('#pay').on('click', function () {
                        layer.open({
                            title: false,
                            type: 1,
                            content: '<img src="/BA/images/xx.png" />',
                            area: ['500px', '250px'],
                            shadeClose: true
                        });
                    });
